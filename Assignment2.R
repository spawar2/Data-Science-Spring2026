 # Author: Pawar, Date: 02/02/2026, Purpose: Test Correlation
...
ggscatter(my_data, x = "Confirmed", y = "Deaths", add = "reg.line", conf.int = TRUE, cor.coef = TRUE, cor.method = "pearson", xlab = "Confirmed Cases", ylab = "Deaths Cases")
